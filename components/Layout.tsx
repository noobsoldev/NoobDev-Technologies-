        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/919810141789" target="_blank" rel="noopener noreferrer" title="WhatsApp" aria-label="WhatsApp" className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#FF0000] hover:text-[#FF0000] transition-all">
